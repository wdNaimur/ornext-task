...
const PlanSection = () => {
  ...
  return (
    <div className="relative overflow-hidden py-16 px-4 text-white flex flex-col items-center">
      {/* Background Zoom Layer */}
      <div className="absolute inset-0 scale-100 will-change-transform z-0 overflow-hidden">
        <img
          className="w-full h-full object-contain animate-bgZoom"
          src="/plan-icon/plan-background.png"
          alt="Background"
        />
      </div>
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 md:gap-10 gap-6 max-w-6xl w-full md:mt-8">
          {pricingPlans[activeTab].map((plan, idx) => (
            <div
              key={idx}
              className={`rounded-2xl bg-black/20 backdrop-blur-sm p-6 shadow-md flex flex-col items-center border-2 hover:border-primary-500 border-gray-900 transition-all ${
